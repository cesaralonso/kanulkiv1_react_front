...
export default class PlumbagoTenants extends Component {
  constructor(props) {
    super(props);
  ...
  async getDebtors() {
    try {
      const response = await fetch(
        TenantsAPI.debtorsByCondoId(CONDO.PLUMBAGO.ID)
      );
  ...
  onRowClick(resident) {
    this.props.history.push(PlumbagoURL.RESIDENT_INFO(resident.user_id));
  }
            ...
            <Card>
              <CardHeader>
                ...
                <h6 className="mb-4">
                  ...
                  {CONDO.PLUMBAGO.NAME} - Residentes
                </h6>

...
export default class SevillaClubHouse extends Component {
  constructor(props) {
    super(props);
  ...
  async getReservations() {
    try {
      const response = await fetch(
        ClubHouseReservationsAPI.byCondoId(CONDO.SEVILLA.ID)
      );
   ...
   */
  eventClick({ event }) {
    this.props.history.push(SevillaURL.RESERVATION(event.extendedProps.id));
  }
  ...
  async onSubmit(e) {
    ...
    if (tenant_id === "") {
      ...
      try {
        ...
        body.append("condo_id", CONDO.SEVILLA.ID);
      ...
      <div className="animated fadeIn">
        <Card>
          ...
          <Card.Header>
            {/* Title */}
            <h6 className="mb-4">
              <i className="fa fa-glass"></i> {CONDO.SEVILLA.NAME} - Casa club
            </h6>
            ...
            <Nav variant="tabs">
              {/* Condo tab */}
              <Nav.Item>
                <Nav.Link as={NavLink} exact={true} to={SevillaURL.INDEX}>
              ...
              {/* Houses tab */}
              <Nav.Item>
                <Nav.Link as={NavLink} exact={true} to={SevillaURL.HOUSES}>
              ...
              {/* Club house tab */}
              <Nav.Item>
                <Nav.Link as={NavLink} exact={true} to={SevillaURL.CLUB_HOUSE}>
              ...
              {/* Residents tab */}
              <Nav.Item>
                <Nav.Link as={NavLink} exact={true} to={SevillaURL.RESIDENTS}>
              ...
              {/* Add user tab */}
              <Nav.Item>
                <Nav.Link as={NavLink} exact={true} to={SevillaURL.ADD_USER}>

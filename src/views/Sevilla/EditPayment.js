...
export default class SevillaEditPayment extends Component {
  constructor(props) {
    super(props);
    ...
    if (type === "0") {
      ...
      try {
        ...
        if (result) {
          ...
          const route = SevillaURL.RESIDENT_PAYMENTS(tenant.user_id);
      ...
      <div className="animated fadeIn">
        <Card>
          ...
          <Card.Footer>
            ...
            {/* Cancel button */}
            <Link to={SevillaURL.RESIDENT_PAYMENTS(tenant.user_id)}>

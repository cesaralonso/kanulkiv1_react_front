...
export default class SevillaTenantInfo extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="animated fadeIn">
        <Card>
          ...
          <Card.Footer>
            {/* Edit button */}
            <Link to={SevillaURL.EDIT_RESIDENT(tenant.user_id)}>
            ...
            {/* Edit button */}
            <Link to={SevillaURL.editPassword(tenant.user_id)}>
            ...
            {/* Add charge */}
            <Link to={SevillaURL.ADD_CHARGE(tenant.user_id)}>
            ...
            {/* Cancel button */}
            <Button onClick={this.onClickBack} variant="danger">
              Regresar
            </Button>
          </Card.Footer>
        </Card>

...
export default class Sevilla extends Component {
  constructor(props) {
    super(props);
  ...
  async getFees() {
    try {
      const response = await fetch(CondoFeesAPI.feeById(CONDO.SEVILLA.ID));
      ...
      <div className="animated fadeIn">
        <Card>
          ...
          <Card.Header>
            {/* Title */}
            <h6 className="mb-4">
              <i className="fa fa-building-o mr-1"></i> {CONDO.SEVILLA.NAME}
            </h6>
